...
root.geometry('288x400')
root.resizable(0,0)
root.config(background="black")

result_label=Label(root,text='',bg="black",fg="white")
result_label.grid(row=0,column=0,columnspan=5,pady=(45,20),sticky='w')
...
btn_mul=Button(root,text='x',bg='#00a65a',fg='white',width=5,height=2)
